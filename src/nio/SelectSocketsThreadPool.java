...
public class SelectSocketsThreadPool extends SelectSockets {
   ...
   * awakened to service the channel associated with a SelectionKey object. The
   ...
   * in the thread object then calls notify( ) to wake it up. When the channel
   * has been drained, the worker thread returns itself to its parent pool.
   */
  private class WorkerThread extends Thread {
     ...
     * thread is servicing it. 通过一个被提供SelectionKey对象的工作线程来初始化一个工作集合，这个方法是同步的，所以
